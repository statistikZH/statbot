...
![Example of NER](https://github.com/statistikZH/statbot/blob/main/documentation/figures/ner_example.png)
Picture source: Wikicommons distributed under a CC-BY 2.0 license.
