...
create_spatial_units<-function(){
  ...
  # TODO old logic has to be deleted
    # we need a valid_from and valid_until values
    gde$spatialunit_ontology<-"A.ADM3"
    gde<-gde %>% rename(spatialunit_id=municipalityId,spatialunit_name=municipalityLongName)
