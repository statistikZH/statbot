# Script to create a dimension table for the dataset:  1_01_027
#
...
unique_dimension_names <- c("place_of_birth", "citizenship")

# should any dimension be ignored? the reason could be, that it already exists
ignore_dimensions <- c("Bevölkerungstyp")
