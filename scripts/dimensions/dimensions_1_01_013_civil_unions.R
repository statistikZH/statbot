# Script to create a dimension table for the dataset:  1_01_013_civil_unions
#
# Created by: C.Ruiz
...
destfile<-"temp/1_01_013_CH.px"

if(!file.exists(destfile)){
  download.file(paste0("https://www.bfs.admin.ch/bfsstatic/dam/assets/",get_bfs_asset_nr("px-x-0102020208_101"),"/master"),destfile=destfile)
}
...
unique_dimension_names <- c("civil_union_type","marital_status_first_partner","marital_status_second_partner",
                            "citizenship_category_partners", "age_class_first_partner","age_class_second_partner")

# should any dimension be ignored? the reason could be, that it already exists
#ignore_dimensions <- c("Ehedauer","Altersklasse.des.Ehemannes","Altersklasse.der.Ehefrau")
