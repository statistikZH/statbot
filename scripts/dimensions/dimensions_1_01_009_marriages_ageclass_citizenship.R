# Script to create a dimension table for the dataset:  1_01_009_civil_unions
#
# Created by: C.Ruiz
...
unique_dimension_names <- c("age_class_husband_marriages","marital_status_husband","age_class_wife_marriages","marital_status_wife")
...
ignore_dimensions<- c(
                      "Staatsangehörigkeit..Auswahl..des.Ehemannes",
                                       "Staatsangehörigkeit..Auswahl..der.Ehefrau")
