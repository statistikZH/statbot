# Script to create a dimension table for the dataset:  1_01_008_eheschliessungen
#
...
destfile<-"temp/1_01_008_eheschliessungen.px"
...
unique_dimension_names <- c("citizenship_category_husband", "citizenship_category_wife")
