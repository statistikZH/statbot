# Script to create a dimension table for the dataset:  1_01_001_CH
#
...
if(!file.exists(destfile)){
  download_bfs_file(paste0("https://www.bfs.admin.ch/bfsstatic/dam/assets/",get_bfs_asset_nr("px-x-0102010000_101"),"/master"),destfile=destfile)
}
