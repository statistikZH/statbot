# Script to create a dimension table for the dataset:  1_01_011_scheidungen
#
# Created by: C.Ruiz
...
destfile<-"temp/1_01_012_scheidungen.px"
...
unique_dimension_names <- c("citizenship_selection_husband", "citizenship_selection_wife")
