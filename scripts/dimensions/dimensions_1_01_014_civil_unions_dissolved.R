# Script to create a dimension table for the dataset:  1_01_014_civil_unions
#
# Created by: C.Ruiz
...
destfile<-"temp/1_01_014_CH.px"

if(!file.exists(destfile)){
  download.file(paste0("https://www.bfs.admin.ch/bfsstatic/dam/assets/",get_bfs_asset_nr("px-x-0102020208_102"),"/master"),destfile=destfile)
}
...
unique_dimension_names <- c("duration_of_civil_union")
...
ignore_dimensions<- c("Partnerschaft","Staatsangehörigkeit..Kategorie..der.Partner","Altersklasse.Partner.in.1","Altersklasse.Partner.in.2")
