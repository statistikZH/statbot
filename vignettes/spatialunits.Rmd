...
vignette: >
  %\VignetteIndexEntry{Spatial-Units}
...
![Spatial Units Table in DB-Scheme V3.0.2](img/spatialunit.PNG).
...
![Spatial Unit Ontology Adapted to our needs from geonames](img/geonames.png)
