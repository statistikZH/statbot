#' Function do download the dataset with the id: 1_01_013_CH
#'
...
#' History
#'
#' Version 3.2.0 - 10.03.2022 - First version copied from 1_01_013
#'
#' @param flag_force_update To force an update of the Dataset. Default: FALSE
#'
#' @export
statbot_src_1_01_013_CH <- function(flag_force_update=FALSE){
  ...
  if(check_changes_in_input_file(destfile)|flag_force_update){
    ...
    fwrite(df,"data/values/1_01_013_CH.csv",row.names = F)
    update_last_updated("1_01_013")

    #convert_and_write_per_unit(df,"1_01_013_CH.csv",how_many=1000)
